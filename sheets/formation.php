...
$formation = (isset($_SESSION['formation'])) ? $_SESSION['formation'] : header("location: ../index.html");
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title><?php echo $trainer->first_name_user.' '.$trainer->last_name_user; ?></title>
        ...
        <div class="wrapper">
            <div class="sidebar">
                <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
                    ...
                    <h1 class="mt-2"><?php echo $trainer->first_name_user.' '.$trainer->last_name_user; ?></h1>
                    ...
                    <div class="d-flex align-items-end justify-content-between">
                        ...
                        <a class="mx-2" href="mailto:<?php echo $trainer->email_user; ?>">
                            <i class="bi bi-mail"></i><?php echo $trainer->email_user; ?>
                        </a>
                    </div>
                </div>
